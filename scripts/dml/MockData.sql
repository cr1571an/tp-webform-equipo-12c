...
/* COMPRAS */
INSERT INTO Compras (IdUsuario, IdProveedor, IdMedioPago, FechaCompra, NumeroFactura, Total, Activo) VALUES
(3, 1, 4, GETDATE(), 'C-0001-00000001', 114000, 1),
(3, 2, 4, GETDATE(), 'C-0001-00000002', 137000, 1),
(3, 3, 1, GETDATE(), 'C-0001-00000003', 48600, 1),
(3, 4, 4, GETDATE(), 'C-0001-00000004', 31500, 1),
(3, 5, 5, GETDATE(), 'C-0001-00000005', 22400, 1),
(3, 6, 4, DATEADD(DAY,-1,GETDATE()), 'C-0001-00000006', 30500, 1),
(3, 1, 4, DATEADD(DAY,-2,GETDATE()), 'C-0001-00000007', 142500, 1),
(3, 2, 4, DATEADD(DAY,-3,GETDATE()), 'C-0001-00000008', 28800, 1),
(3, 3, 1, DATEADD(DAY,-4,GETDATE()), 'C-0001-00000009', 64800, 1),
(3, 4, 4, DATEADD(DAY,-5,GETDATE()), 'C-0001-00000010', 45000, 1),
(3, 5, 5, DATEADD(DAY,-6,GETDATE()), 'C-0001-00000011', 28000, 1),
(3, 6, 4, DATEADD(DAY,-7,GETDATE()), 'C-0001-00000012', 24400, 0),
(3, 1, 4, DATEADD(DAY,-8,GETDATE()), 'C-0001-00000013', 85500, 1),
(3, 2, 4, DATEADD(DAY,-9,GETDATE()), 'C-0001-00000014', 43200, 1),
(3, 3, 1, DATEADD(DAY,-10,GETDATE()), 'C-0001-00000015', 81000, 1),
(3, 4, 4, DATEADD(DAY,-11,GETDATE()), 'C-0001-00000016', 27000, 0),
(3, 5, 5, DATEADD(DAY,-12,GETDATE()), 'C-0001-00000017', 33600, 1),
(3, 6, 4, DATEADD(DAY,-13,GETDATE()), 'C-0001-00000018', 36600, 1),
(3, 1, 4, DATEADD(DAY,-14,GETDATE()), 'C-0001-00000019', 114000, 1),
(3, 2, 4, DATEADD(DAY,-15,GETDATE()), 'C-0001-00000020', 21600, 1),
(3, 3, 1, DATEADD(DAY,-16,GETDATE()), 'C-0001-00000021', 97200, 1),
(3, 4, 4, DATEADD(DAY,-17,GETDATE()), 'C-0001-00000022', 18000, 0),
(3, 5, 5, DATEADD(DAY,-18,GETDATE()), 'C-0001-00000023', 44800, 1),
(3, 6, 4, DATEADD(DAY,-19,GETDATE()), 'C-0001-00000024', 61000, 1),
(3, 1, 4, DATEADD(DAY,-20,GETDATE()), 'C-0001-00000025', 57000, 0);
GO
